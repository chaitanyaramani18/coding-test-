...
class Property(models.Model):
	...
	visitor_id = models.ForeignKey('homelyapp.Visitor', on_delete=models.CASCADE, null = True) 
	owner = models.ForeignKey('homelyapp.Owner', on_delete=models.CASCADE, null = True)
	def __str__(self):
		return str(self.id)
...
class Rented(models.Model):
	owner_id = models.ForeignKey('homelyapp.Owner',on_delete = models.CASCADE )
	prop_id = models.ForeignKey('homelyapp.Property',on_delete = models.CASCADE )
	visitor_id = models.ForeignKey('homelyapp.Visitor',on_delete = models.CASCADE )
